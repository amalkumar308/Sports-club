...
//$stud = $candi_result->fetch_array();
 ...
 if($sprts_sp == 'athlete') 
      {         
        location:'handler_athlete_delet.php';
      }
      else 
      {
         $error = "Your Login Name or Password is invalid";
         echo "<script>alert('you are not autherised to delete another specilisation sports');window.location='handler_athlete_home.php';</script>";
         //die();
      }  
