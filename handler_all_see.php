...
$candi_detail = "SELECT * FROM candidate";
...
<div class="container" >
			<div class="col-sm-12" >
<h2><marquee>ALL CANDIDATE</marquee></h2>
<hr>
</div>
</div>


<!--display details of registered candidates-->
	<div class="container">    
                      ...
                      <?php
		                  ...
		                  echo "<caption> REGISTERED CANDIDATES</capiton>";
                          echo "<tr><th>User_id</th><th>First name</th><th>Middle name</th><th>Last name</th><th>Contact no</th><th>Email</th><th>Branch</th><th>Year</th></tr>";
