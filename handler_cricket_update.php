...
//QUERY TO FETCH ALL details of candidate who play cricket

$candi_detail = "SELECT * FROM sports_choice S,candidate C where S.choice = 'cricket' and S.user_id=C.user_id";
$candi_result = $con->query($candi_detail);

if($sprts_sp == 'cricket') 
      {         
        location:'handler_cricket_update.php';
      }
      else 
      {
         //$error = "Your Login Name or Password is invalid";
         echo "<script>alert('you are not autherised to update another specilisation sports');window.location='handler_crick_home.php';</script>";
         //die();
      }   
...
<!--display details of candiadates-->
	<div class="container">    
                      ...
                      <?php
		                  ...
		                  echo "<caption> REGISTERED CANDIDATES FOR CRICKET</capiton>";
