...
if($sprts_sp == 'cricket') 
      {         
        location:'handler_cricket_delet.php';
      }
      else 
      {
         //$error = "Your Login Name or Password is invalid";
         echo "<script>alert('you are not autherised to delete another specilisation sports');window.location='handler_crick_home.php';</script>";
         //die();
      }   
                         ...
                         while($row=$candi_result->fetch_array())
                           {
                            ...
                            <td><input type='submit' name='sub'  value='DELETE' class='btn btn-info'><i class='icon-hand-right'></i></td>
	                             </form></tr>";
	                        }
		                 echo "</table>";
		                ?>
