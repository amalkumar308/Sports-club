	...
	<div class="modal-body">
        <form method="POST" align="center" action="blog_page.php">
          <div class="form-group">
            <h3><label for="blog title" align="center" style="color:black;">Winners never quit and quitters never win.</label>
			...
			<div class="jumbotron">
                <div id="sliderFrame">
                   <div id="slider">
					...
					<img src="images/01.jpg" alt="Welcome to MNNIT Sports Club" />
...
<br>         The inclusion of mind sports within sport definitions has not been universally accepted, leading 
             ...
             and mental well-being, forming social relationships or obtaining results in competition at all levels."</p>
					<br><br>
					 ...
					 <a href="faq.php"> <input type="submit" value="FAQs"class="btn btn-info"><i class="icon-hand-right"></i></a>
							     </div>
