...
$candi_detail = "SELECT * FROM sports_choice S,candidate C where S.choice = 'athlete' and S.user_id=C.user_id";
$candi_result = $con->query($candi_detail);
//$stud = $candi_result->fetch_array();

 if($sprts_sp == 'athlete') 
      {         
        location:'handler_athlete_update.php';
      }
      else 
      {
         $error = "Your Login Name or Password is invalid";
         echo "<script>alert('you are not autherised to update another specilisation sports');window.location='handler_athlete_home.php';</script>";
         //die();
      }  
