...
//QUERY TO FETCH ALL details of candidate who play basketball

$candi_detail = "SELECT * FROM sports_choice S,candidate C where S.choice = 'basketball' and S.selec_stetus='Selected' and S.user_id=C.user_id";
