...
<nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="container-fluid" style="margin-top: 0px">
			...
			<div class="jumbotron">
                <div id="sliderFrame">
                   <div id="slider">
                      ...
                      <img src="ftball_images/01.jpg" alt="" />
                      <img src="ftball_images/02.jpg" alt="" />
                      <img src="ftball_images/03.jpg" alt="" />
                      <img src="ftball_images/04.jpg" alt="" />
                      <img src="ftball_images/05.jpg" alt="" />
		...
		<div class="container" >
			<div class="col-sm-12" >
				<h2><label align="center" style="color:#FFFFFF">About Football</label></h2>
				<hr>
				<br>
					<p>
