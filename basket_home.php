...
<nav class="navbar navbar-inverse navbar-fixed-top">
		 <div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="#"><?php echo "Welc ome to MNNIT Sports club" ;?></a>
			</div>
			
		 
			<ul class="nav navbar-nav">
				<li class="active"><a href="index.php">Home</a></li>
				<li class="active"><a href="athlete_home.php">Athlete</a></li>
	...
	<div class="modal-body">
        <form method="POST" align="center" action="blog_page.php">
	...
	<div class="container-fluid" style="margin-top: 0px">
			...
			<div class="jumbotron">
                <div id="sliderFrame">
                   <div id="slider">
                      ...
                      <img src="basket_images/bsk01.jpg" alt="" />
                      <img src="basket_images/bsk02.jpg" alt="" />
                      <img src="basket_images/bsk03.jpg" alt="" />
                      <img src="basket_images/bsk04.jpg" alt="" />
                	  <img src="basket_images/bsk05.jpg" alt="" />
	                </div>
		...
		<div class="container" >
			<div class="col-sm-12" >
				<h2><label align="center" style="color:#FFFFFF">About Basketball</label></h2>
				<hr>
				<br>
					<p>
